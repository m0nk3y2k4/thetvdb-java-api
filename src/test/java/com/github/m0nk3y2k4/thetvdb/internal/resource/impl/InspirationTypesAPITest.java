...
import static com.github.m0nk3y2k4.thetvdb.internal.resource.impl.InspirationTypesAPI.getAllInspirationTypes;
...
class InspirationTypesAPITest {
    ...
    private static Stream<Arguments> withValidParameters() {
        return Stream.of(
                of(route(con -> getAllInspirationTypes(con), "getAllInspirationTypes()"), INSPIRATIONTYPE_OVERVIEW)
        );
    }
    //@EnableFormatting

    @ParameterizedTest(name = "[{index}] Route InspirationTypesAPI.{0} successfully invoked")
