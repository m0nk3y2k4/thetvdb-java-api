...
import static com.github.m0nk3y2k4.thetvdb.internal.resource.impl.CompanyTypesAPI.getAllCompanyTypes;
...
class CompanyTypesAPITest {
    ...
    private static Stream<Arguments> withValidParameters() {
        return Stream.of(
                of(route(con -> getAllCompanyTypes(con), "getAllCompanyTypes()"), COMPANYTYPE_LIST)
        );
    }
    //@EnableFormatting

    @ParameterizedTest(name = "[{index}] Route CompanyTypesAPI.{0} successfully invoked")
