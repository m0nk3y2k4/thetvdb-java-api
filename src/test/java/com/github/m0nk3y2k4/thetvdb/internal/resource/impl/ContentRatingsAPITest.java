...
import static com.github.m0nk3y2k4.thetvdb.internal.resource.impl.ContentRatingsAPI.getAllContentRatings;
...
class ContentRatingsAPITest {
    ...
    @ParameterizedTest(name = "[{index}] Route ContentRatingsAPI.{0} successfully invoked")
