...
import static com.github.m0nk3y2k4.thetvdb.internal.resource.impl.ArtworkTypesAPI.getAllArtworkTypes;
...
class ArtworkTypesAPITest {
    ...
    @ParameterizedTest(name = "[{index}] Route ArtworkTypesAPI.{0} successfully invoked")
    ...
    void invokeRoute_withValidParameters_verifyResponse(TestRemoteAPICall route, JSONTestUtil.JsonResource expected,
        ...
        assertThat(route.invoke(new APIConnection("IR7GH9W4GH76E7T", remoteAPI))).isEqualTo(expected.getJson());
    }
}
