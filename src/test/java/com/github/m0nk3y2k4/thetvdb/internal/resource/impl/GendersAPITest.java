...
import static com.github.m0nk3y2k4.thetvdb.internal.resource.impl.GendersAPI.getAllGenders;
...
class GendersAPITest {
    ...
    @ParameterizedTest(name = "[{index}] Route GendersAPI.{0} successfully invoked")
