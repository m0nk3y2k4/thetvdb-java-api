...
@IntegrationTestSuite("CompanyTypes")
class CompanyTypesIT {

    @Test
    @Order(1)
    void getAllCompanyTypes(TheTVDBApi api) {
        assertThat(api::getAllCompanyTypes).as("/company-types").doesNotThrowAnyException();
    }
}
