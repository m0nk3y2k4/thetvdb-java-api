...
@IntegrationTestSuite("ContentRatings")
class ContentRatingsIT {

    @Test
    @Order(1)
    void getAllContentRatings(TheTVDBApi api) {
        assertThat(api::getAllContentRatings).as("/content/ratings").doesNotThrowAnyException();
    }
}
