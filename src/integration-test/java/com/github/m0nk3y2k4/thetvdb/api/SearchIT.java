...
import static com.github.m0nk3y2k4.thetvdb.api.enumeration.SearchType.SERIES;
...
class SearchIT {
    ...
    @Test
    @Order(1)
    void search(TheTVDBApi api) {
        assertThat(() -> api.search("Djatlow", SERIES)).as("/search?query=Djatlow&type=series")
