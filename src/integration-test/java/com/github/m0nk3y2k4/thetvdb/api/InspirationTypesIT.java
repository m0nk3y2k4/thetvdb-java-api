...
@IntegrationTestSuite("InspirationTypes")
class InspirationTypesIT {

    @Test
    @Order(1)
    void getAllInspirationTypes(TheTVDBApi api) {
        assertThat(api::getAllInspirationTypes).as("/inspiration/types").doesNotThrowAnyException();
    }
}
