 ...
 * <p><br>
 * The methods of this class provide easy access to all series summary related data which was returned by the remote
 * service in JSON format. Please note that, as the remote service declares all of the properties to be optional, most
 * of the methods are marked as {@link Nullable}. Methods returning collection-based values however will return an empty
