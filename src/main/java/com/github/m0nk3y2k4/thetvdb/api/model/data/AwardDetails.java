 ...
 * <a target="_blank" href="https://app.swaggerhub.com/apis-docs/thetvdb/tvdb-api_v_4/4.3.2#/AwardExtendedRecord">AwardExtendedRecord</a>
 * data transfer object.
 * <p><br>
 * The methods of this class provide easy access to all award related data which was returned by the remote service in
...
public interface AwardDetails {
     ...
     *
     * @return The <em>{@code categories}</em> property from the received JSON
     */
