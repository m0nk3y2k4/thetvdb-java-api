...
/**
 * Interface representing an <em>{@code InspirationType}</em> data transfer object.
 * <p><br>
 * The methods of this class provide easy access to all inspiration type related data which was returned by the remote
 ...
 */
public interface InspirationType {
    ...
    /**
     * Get the value of the {<em>{@code data.reference_name}</em>} JSON property
     *
     * @return The <em>{@code reference_name}</em> property from the received JSON
     */
    @Nullable
