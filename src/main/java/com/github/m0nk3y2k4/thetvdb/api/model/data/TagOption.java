 ...
 * <a target="_blank" href="https://app.swaggerhub.com/apis-docs/thetvdb/tvdb-api_v_4/4.0.0#/TagOption">TagOption</a>
...
public interface TagOption {
    ...
    /**
     * Get the value of the {<em>{@code <enclosing>.helpText}</em>} JSON property
     *
    ...
    /**
     * Get the value of the {<em>{@code <enclosing>.tag}</em>} JSON property
     *
    ...
    /**
     * Get the value of the {<em>{@code <enclosing>.tagName}</em>} JSON property
     *
