 ...
 * <a target="_blank" href="https://app.swaggerhub.com/apis-docs/thetvdb/tvdb-api_v_4/4.0.0#/AwardCategoryExtendedRecord">AwardCategoryExtendedRecord</a>
...
public interface AwardCategoryDetails {
     ...
     *
     * @return The <em>{@code nominees}</em> property from the received JSON
     */
    List<AwardNominee> getNominees();
}
