...
/**
 * Interface representing an <em>{@code UserInfo}</em> data transfer object.
 * <p><br>
 * The methods of this class provide easy access to all user related information which was returned by the remote
