...
/**
 * Interface representing a <em>{@code TranslationExtended}</em> data transfer object.
 * <p><br>
 * The methods of this class provide easy access to all extended translation related data which was returned by the
 * remote service in JSON format. Methods returning collection-based values will return an empty collection in case no
 ...
 */
public interface MetaTranslations {
