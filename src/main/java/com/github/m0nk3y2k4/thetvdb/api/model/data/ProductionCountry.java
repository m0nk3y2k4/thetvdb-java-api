...
/**
 * Interface representing an <em>{@code ProductionCountry}</em> data transfer object.
 * <p><br>
 * The methods of this class provide easy access to all production country related data which was returned by the remote
