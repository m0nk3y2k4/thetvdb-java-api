...
/**
 * DTO implementation of the {@link Inspiration} interface
 * <p><br>
...
@JsonDeserialize(builder = InspirationDTO.Builder.class)
public abstract class InspirationDTO implements Inspiration {
    ...
    /**
     * Builder used to create a new immutable {@link InspirationDTO} implementation
     * <p><br>
     * This builder provides a fluent API for setting certain object properties and creating a new immutable
     * {@link InspirationDTO} instance based on these properties. New builders may be initialized with some existing DTO
     ...
     */
    public static class Builder extends InspirationDTOBuilder {}
}
