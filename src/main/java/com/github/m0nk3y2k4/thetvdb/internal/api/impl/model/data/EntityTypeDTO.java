...
/**
 * DTO implementation of the {@link EntityType} interface
 * <p><br>
...
@JsonDeserialize(builder = EntityTypeDTO.Builder.class)
public abstract class EntityTypeDTO implements EntityType {

    /**
     * Builder used to create a new immutable {@link EntityTypeDTO} implementation
     * <p><br>
     * This builder provides a fluent API for setting certain object properties and creating a new immutable
     * {@link EntityTypeDTO} instance based on these properties. New builders may be initialized with some existing DTO
     ...
     */
    public static class Builder extends EntityTypeDTOBuilder {}
}
