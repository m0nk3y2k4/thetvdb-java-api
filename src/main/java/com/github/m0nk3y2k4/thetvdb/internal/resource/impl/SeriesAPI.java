...
/**
 * Implementation of a connector for the remote API's <a href="https://api.thetvdb.com/swagger#/Series">Series</a>
 * endpoint.
 * <p><br>
 * Provides static access to all routes of this endpoint which may be used to gather information about a specific
 * series.
 */
public final class SeriesAPI extends QueryResource {
    ...
    /**
     * Returns header information for a specific series as raw JSON. Good for getting the Last-Updated header to find
     * out when the series was last modified.
     * <p><br>
    ...
    /**
     * Returns all episodes of a specific series as raw JSON. Results will be paginated with 100 results per page. Use
     * <em>{@code params}</em> to select a specific result page.
     * <p><br>
     ...
     *                      series ID does not exist, etc.
     */
    public static JsonNode getEpisodes(@Nonnull APIConnection con, long id, @CheckForNull QueryParameters params)
            throws APIException {
        Parameters.validatePathParam(PATH_ID, id, ID_VALIDATOR);
     ...
     * params}</em> to filter for specific episodes or to select a specific result page.
     * <p><br>
     ...
     *               parameters see the API documentation or use {@link #getEpisodesQueryParams(APIConnection, long)
     *               getEpisodesQueryParams(con, id)}.
     *
     ...
     */
    public static JsonNode queryEpisodes(@Nonnull APIConnection con, long id, @CheckForNull QueryParameters params)
            throws APIException {
        Parameters.validatePathParam(PATH_ID, id, ID_VALIDATOR);
    ...
    /**
     * Returns a list of keys which are valid parameters for querying episodes, as raw JSON. These keys are permitted to
     * be used in {@link QueryParameters} objects when querying for specific episodes of a series.
     * <p><br>
     ...
     * @param id     The <i>TheTVDB.com</i> series ID
     * @param params Object containing key/value pairs of query parameters. For a complete list of possible query
     *               parameters see the API documentation or use {@link #getFilterParams(APIConnection, long)
     *               getFilterParams(con, seriesId)}.
     *
     ...
     *                      series ID does not exist, etc.
     */
    public static JsonNode filter(@Nonnull APIConnection con, long id, @CheckForNull QueryParameters params)
            throws APIException {
        Parameters.validatePathParam(PATH_ID, id, ID_VALIDATOR);
    ...
    /**
     * Returns a list of keys which are valid parameters for filtering series, as raw JSON. These keys are permitted to
     * be used in {@link QueryParameters} objects when filtering for a specific series.
     * <p><br>
     ...
     * @param id     The <i>TheTVDB.com</i> series ID
     * @param params Object containing key/value pairs of query parameters. For a complete list of possible query
     *               parameters see the API documentation or use {@link #getImagesQueryParams(APIConnection, long)
     *               getImagesQueryParams(con, seriesId)}.
     *
     ...
     *                      series ID does not exist, etc. or if no records are found that match your query.
     */
    public static JsonNode queryImages(@Nonnull APIConnection con, long id, @CheckForNull QueryParameters params)
            throws APIException {
        Parameters.validatePathParam(PATH_ID, id, ID_VALIDATOR);
    ...
    /**
     * Returns a list of valid parameters for querying a series images, as raw JSON. Unlike other routes, querying for a
     * series images may be restricted to certain combinations of query keys. The allowed combinations are clustered in
     * the data array of the returned JSON object.
     * <p><br>
