 ...
 * "hide" them.
 * <p><br>
 * This is a composed annotation providing some commonly used preconfiguration for DTO's with regard to the
 * <em>{@code Immutables}</em> API. It forces the actual immutable implementation to be private and the corresponding
 * builder to be package-private.
 */
@Documented
@Value.Style(
