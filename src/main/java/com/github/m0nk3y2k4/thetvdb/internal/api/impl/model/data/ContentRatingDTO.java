...
/**
 * DTO implementation of the {@link ContentRating} interface
 * <p><br>
...
@JsonDeserialize(builder = ContentRatingDTO.Builder.class)
public abstract class ContentRatingDTO implements ContentRating {

    /**
     * Builder used to create a new immutable {@link ContentRatingDTO} implementation
     * <p><br>
     * This builder provides a fluent API for setting certain object properties and creating a new immutable
     * {@link ContentRatingDTO} instance based on these properties. New builders may be initialized with some existing
     ...
     */
    public static class Builder extends ContentRatingDTOBuilder {}
}
