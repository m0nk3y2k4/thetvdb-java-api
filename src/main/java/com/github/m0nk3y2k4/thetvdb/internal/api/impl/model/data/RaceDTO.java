...
/**
 * DTO implementation of the {@link Race} interface
 * <p><br>
...
@JsonDeserialize(builder = RaceDTO.Builder.class)
public abstract class RaceDTO implements Race {

    /**
     * Builder used to create a new immutable {@link RaceDTO} implementation
     * <p><br>
     * This builder provides a fluent API for setting certain object properties and creating a new immutable {@link
     * RaceDTO} instance based on these properties. New builders may be initialized with some existing DTO instance,
     ...
     */
    public static class Builder extends RaceDTOBuilder {}
}
