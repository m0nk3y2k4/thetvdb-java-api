 ...
 * <a target="_blank" href="https://thetvdb.github.io/v4-api/#/Source%20Types">Source Types</a>
 * endpoint.
 * <p><br>
 * Provides static access to all routes of this endpoint which may be used for obtaining an overview of available source
 * type records.
 */
public final class SourceTypesAPI extends Resource {

    private SourceTypesAPI() {}        // Private constructor. Only static methods
     ...
     *
     * @return JSON object containing an overview of available source types
     *
     * @throws APIException If an exception with the remote API occurs, e.g. authentication failure, IO error, resource
     *                      not found, etc.
     */
    public static JsonNode getAllSourceTypes(@Nonnull APIConnection con) throws APIException {
        return con.sendGET(createResource("/sources/types"));
    }
}
