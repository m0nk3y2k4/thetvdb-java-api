...
/**
 * Wrapper class for Jackson {@link CollectionDeserializer} objects
 * <p><br>
 ...
 * Java connector in order to also support such scenarios. This can be achieved by using this wrapper around collection
 * based JSON deserializers. It supports all kinds of list content types except for simple String-value lists. For this
 * please use the {@link NullableStringCollectionWrapper} which wraps a specific JSON String collection-deserializer
 * that is optimized for lists containing only String values.
 */
public final class NullableCollectionWrapper extends ContainerDeserializerBase<Collection<Object>> implements ContextualDeserializer {

    /** The wrapped CollectionDeserializer instance */
    private final CollectionDeserializer deser;
     ...
     */
    NullableCollectionWrapper(@Nonnull CollectionDeserializer deser) {
        super(deser.getContentType(), null, null);
        this.deser = deser;
    }
    ...
    public JsonDeserializer<?> createContextual(DeserializationContext ctxt, BeanProperty property)
        ...
        return new NullableCollectionWrapper(deser.createContextual(ctxt, property));
    }
     ...
     */
    @Override
    public Collection<Object> getNullValue(DeserializationContext ctxt) {
        // CollectionDeserializer returns null-value by default what leads to a NPE in DTO builders
