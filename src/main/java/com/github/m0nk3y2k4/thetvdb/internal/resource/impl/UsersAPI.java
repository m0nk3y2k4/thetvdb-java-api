...
/**
 * Implementation of a connector for the remote API's <a href="https://api.thetvdb.com/swagger#/Users">Users</a>
 * endpoint.
 * <p><br>
...
public final class UsersAPI extends QueryResource {
    ...
    private static final Predicate<String> ITEMTYPE_VALIDATOR = value -> Arrays.asList("series", "episode", "image")
            .contains(value);
     ...
     *               parameters see the API documentation or use {@link #getRatingsQueryParams(APIConnection)
     *               getRatingsQueryParams(con)}.
     *
     ...
     *                      not found, etc. or if no information exists for the current user
     */
    public static JsonNode queryRatings(@Nonnull APIConnection con, @CheckForNull QueryParameters params)
            throws APIException {
        return con.sendGET(createQueryResource(BASE, "/ratings/query", params));
    }

    /**
     * Returns a list of valid parameters for querying user ratings, as raw JSON. These keys are permitted to be used in
     * {@link QueryParameters} objects when querying for ratings.
     * <p><br>
     ...
     */
    public static JsonNode deleteFromRatings(@Nonnull APIConnection con, @Nonnull String itemType, long itemId)
            throws APIException {
    ...
    /**
     * Updates a given rating of a given type and returns the modified rating, mapped as raw JSON. If no rating exists
     ...
     *                      not found, etc. or if no rating is found that matches your given parameters
     */
    public static JsonNode addToRatings(@Nonnull APIConnection con, @Nonnull String itemType, long itemId,
            long itemRating) throws APIException {
        Parameters.validatePathParam(PATH_ITEMTYPE, itemType, ITEMTYPE_VALIDATOR);
        Parameters.validatePathParam(PATH_ITEMID, itemId, ID_VALIDATOR);
