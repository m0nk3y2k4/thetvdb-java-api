...
/**
 * DTO implementation of the {@link Biography} interface
 * <p><br>
...
@JsonDeserialize(builder = BiographyDTO.Builder.class)
public abstract class BiographyDTO implements Biography {

    /**
     * Builder used to create a new immutable {@link BiographyDTO} implementation
     * <p><br>
     * This builder provides a fluent API for setting certain object properties and creating a new immutable
     * {@link BiographyDTO} instance based on these properties. New builders may be initialized with some existing DTO
     ...
     */
    public static class Builder extends BiographyDTOBuilder {}
}
