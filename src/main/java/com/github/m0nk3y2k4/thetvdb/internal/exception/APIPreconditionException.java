...
/**
 * Exceptions of this type represent a failed precondition check. Such checks are carried out throughout processing to
 * check whether all the necessary prerequisites for proper processing of the task at hand have been met. Such
 * exceptions typically indicate an implementation error rather than incorrect use of the API.
 */
