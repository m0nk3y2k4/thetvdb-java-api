...
/**
 * DTO implementation of the {@link SeasonType} interface
 * <p><br>
 ...
 * {@link SeasonTypeDTO.Builder}.
 */
@Immutable
@APIDataModel
@WithHiddenImplementation
@JsonDeserialize(builder = SeasonTypeDTO.Builder.class)
public abstract class SeasonTypeDTO implements SeasonType {

    /**
     * Builder used to create a new immutable {@link SeasonTypeDTO} implementation
     * <p><br>
     * This builder provides a fluent API for setting certain object properties and creating a new immutable
     * {@link SeasonTypeDTO} instance based on these properties. New builders may be initialized with some existing DTO
     ...
     */
    public static class Builder extends SeasonTypeDTOBuilder {}
}
