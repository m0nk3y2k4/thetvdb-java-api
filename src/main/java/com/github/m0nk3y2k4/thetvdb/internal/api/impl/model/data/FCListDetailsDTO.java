...
/**
 * DTO implementation of the {@link FCListDetails} interface
 * <p><br>
...
@JsonDeserialize(builder = FCListDetailsDTO.Builder.class)
public abstract class FCListDetailsDTO implements FCListDetails {
    ...
    /**
     * Builder used to create a new immutable {@link FCListDetailsDTO} implementation
     * <p><br>
     * This builder provides a fluent API for setting certain object properties and creating a new immutable
     * {@link FCListDetailsDTO} instance based on these properties. New builders may be initialized with some existing
     ...
     */
    public static class Builder extends FCListDetailsDTOBuilder {}
}
