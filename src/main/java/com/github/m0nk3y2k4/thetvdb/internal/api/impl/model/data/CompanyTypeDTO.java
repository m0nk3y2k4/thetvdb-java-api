...
/**
 * DTO implementation of the {@link CompanyType} interface
 * <p><br>
...
@JsonDeserialize(builder = CompanyTypeDTO.Builder.class)
public abstract class CompanyTypeDTO implements CompanyType {

    /**
     * Builder used to create a new immutable {@link CompanyTypeDTO} implementation
     * <p><br>
     * This builder provides a fluent API for setting certain object properties and creating a new immutable
     * {@link CompanyTypeDTO} instance based on these properties. New builders may be initialized with some existing DTO
     ...
     */
    public static class Builder extends CompanyTypeDTOBuilder {}
}
