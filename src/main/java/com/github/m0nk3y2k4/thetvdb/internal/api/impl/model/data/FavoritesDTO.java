...
/**
 * DTO implementation of the {@link Favorites} interface
 * <p><br>
...
@JsonDeserialize(builder = FavoritesDTO.Builder.class)
public abstract class FavoritesDTO implements Favorites {

    /**
     * Builder used to create a new immutable {@link FavoritesDTO} implementation
     * <p><br>
     * This builder provides a fluent API for setting certain object properties and creating a new immutable
     * {@link FavoritesDTO} instance based on these properties. New builders may be initialized with some existing DTO
     ...
     */
    public static class Builder extends FavoritesDTOBuilder {}
}
