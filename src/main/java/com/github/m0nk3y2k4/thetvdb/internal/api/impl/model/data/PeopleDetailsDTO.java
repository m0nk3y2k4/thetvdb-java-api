...
/**
 * DTO implementation of the {@link PeopleDetails} interface
 * <p><br>
...
@JsonDeserialize(builder = PeopleDetailsDTO.Builder.class)
public abstract class PeopleDetailsDTO implements PeopleDetails {

    /**
     * Builder used to create a new immutable {@link PeopleDetailsDTO} implementation
     * <p><br>
     * This builder provides a fluent API for setting certain object properties and creating a new immutable
     * {@link PeopleDetailsDTO} instance based on these properties. New builders may be initialized with some existing
     ...
     */
    public static class Builder extends PeopleDetailsDTOBuilder {}
}
