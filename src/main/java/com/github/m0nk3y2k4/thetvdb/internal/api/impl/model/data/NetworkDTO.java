...
/**
 * DTO implementation of the {@link Network} interface
 * <p><br>
...
public abstract class NetworkDTO implements Network {

    /**
     * Builder used to create a new immutable {@link NetworkDTO} implementation
     * <p><br>
     * This builder provides a fluent API for setting certain object properties and creating a new immutable {@link
     * NetworkDTO} instance based on these properties. New builders may be initialized with some existing DTO instance,
     ...
     */
    public static class Builder extends NetworkDTOBuilder {}
}
