...
/**
 * DTO implementation of the {@link Character} interface
 * <p><br>
...
@JsonDeserialize(builder = CharacterDTO.Builder.class)
public abstract class CharacterDTO implements Character {

    /**
     * Builder used to create a new immutable {@link CharacterDTO} implementation
     * <p><br>
     * This builder provides a fluent API for setting certain object properties and creating a new immutable
     * {@link CharacterDTO} instance based on these properties. New builders may be initialized with some existing DTO
     ...
     */
    public static class Builder extends CharacterDTOBuilder {}
}
