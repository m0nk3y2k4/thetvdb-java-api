...
/**
 * DTO implementation of the {@link PeopleType} interface
 * <p><br>
...
@JsonDeserialize(builder = PeopleTypeDTO.Builder.class)
public abstract class PeopleTypeDTO implements PeopleType {

    /**
     * Builder used to create a new immutable {@link PeopleTypeDTO} implementation
     * <p><br>
     * This builder provides a fluent API for setting certain object properties and creating a new immutable
     * {@link PeopleTypeDTO} instance based on these properties. New builders may be initialized with some existing DTO
     ...
     */
    public static class Builder extends PeopleTypeDTOBuilder {}
}
