...
/**
 * DTO implementation of the {@link Gender} interface
 * <p><br>
 ...
 * {@link GenderDTO.Builder}.
 */
@Immutable
@APIDataModel
@WithHiddenImplementation
@JsonDeserialize(builder = GenderDTO.Builder.class)
public abstract class GenderDTO implements Gender {

    /**
     * Builder used to create a new immutable {@link GenderDTO} implementation
     * <p><br>
     * This builder provides a fluent API for setting certain object properties and creating a new immutable {@link
     * GenderDTO} instance based on these properties. New builders may be initialized with some existing DTO instance,
     ...
     */
    public static class Builder extends GenderDTOBuilder {}
}
