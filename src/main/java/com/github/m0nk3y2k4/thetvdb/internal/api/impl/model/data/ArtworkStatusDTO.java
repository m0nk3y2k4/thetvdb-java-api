...
/**
 * DTO implementation of the {@link ArtworkStatus} interface
 * <p><br>
 ...
 * {@link ArtworkStatusDTO.Builder}.
 */
@Immutable
@APIDataModel
@WithHiddenImplementation
@JsonDeserialize(builder = ArtworkStatusDTO.Builder.class)
public abstract class ArtworkStatusDTO implements ArtworkStatus {

    /**
     * Builder used to create a new immutable {@link ArtworkStatusDTO} implementation
     * <p><br>
     * This builder provides a fluent API for setting certain object properties and creating a new immutable
     * {@link ArtworkStatusDTO} instance based on these properties. New builders may be initialized with some existing
     ...
     */
    public static class Builder extends ArtworkStatusDTOBuilder {}
}
