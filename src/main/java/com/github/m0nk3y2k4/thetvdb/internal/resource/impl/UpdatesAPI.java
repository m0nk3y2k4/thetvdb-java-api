...
/**
 * Implementation of a connector for the remote API's <a href="https://api.thetvdb.com/swagger#/Updates">Updates</a> endpoint.
 * <p><br>
...
public final class UpdatesAPI extends QueryResource {
     ...
     *               see the API documentation or use {@link #getQueryParams(APIConnection) getQueryParams(con)}.
     *
