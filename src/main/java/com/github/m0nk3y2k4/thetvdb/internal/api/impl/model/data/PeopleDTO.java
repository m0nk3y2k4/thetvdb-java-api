...
public abstract class PeopleDTO implements People {
     ...
     * PeopleDTO} instance based on these properties. New builders may be initialized with some existing DTO instance,
