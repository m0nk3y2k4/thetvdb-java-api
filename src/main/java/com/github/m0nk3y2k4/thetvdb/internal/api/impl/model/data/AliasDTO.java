...
/**
 * DTO implementation of the {@link Alias} interface
 * <p><br>
...
@JsonDeserialize(builder = AliasDTO.Builder.class)
public abstract class AliasDTO implements Alias {

    /**
     * Builder used to create a new immutable {@link AliasDTO} implementation
     * <p><br>
     * This builder provides a fluent API for setting certain object properties and creating a new immutable {@link
     * AliasDTO} instance based on these properties. New builders may be initialized with some existing DTO instance,
     ...
     */
    public static class Builder extends AliasDTOBuilder {}
}
