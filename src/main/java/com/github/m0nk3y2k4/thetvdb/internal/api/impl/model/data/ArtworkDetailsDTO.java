...
/**
 * DTO implementation of the {@link ArtworkDetails} interface
 * <p><br>
...
@JsonDeserialize(builder = ArtworkDetailsDTO.Builder.class)
public abstract class ArtworkDetailsDTO implements ArtworkDetails {

    /**
     * Builder used to create a new immutable {@link ArtworkDetailsDTO} implementation
     * <p><br>
     * This builder provides a fluent API for setting certain object properties and creating a new immutable
     * {@link ArtworkDetailsDTO} instance based on these properties. New builders may be initialized with some existing
     ...
     */
    public static class Builder extends ArtworkDetailsDTOBuilder {}
}
