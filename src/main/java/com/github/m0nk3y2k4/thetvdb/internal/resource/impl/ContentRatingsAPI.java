 ...
 * <a target="_blank" href="https://app.swaggerhub.com/apis-docs/thetvdb/tvdb-api_v_4/4.3.2#/content-ratings">content-ratings</a>
 * endpoint.
 * <p><br>
 * Provides static access to all routes of this endpoint which may be used for obtaining an overview of available
 * content rating records.
 */
public final class ContentRatingsAPI extends Resource {
     ...
     *
     * @return JSON object containing an overview of available content ratings
     *
     * @throws APIException If an exception with the remote API occurs, e.g. authentication failure, IO error, resource
     *                      not found, etc.
     */
    public static JsonNode getAllContentRatings(@Nonnull APIConnection con) throws APIException {
        return con.sendGET(createResource("/content/ratings"));
    }
}
