...
/**
 * DTO implementation of the {@link SourceType} interface
 * <p><br>
 ...
 * {@link SourceTypeDTO.Builder}.
 */
@Immutable
@APIDataModel
@WithHiddenImplementation
@JsonDeserialize(builder = SourceTypeDTO.Builder.class)
public abstract class SourceTypeDTO implements SourceType {

    /**
     * Builder used to create a new immutable {@link SourceTypeDTO} implementation
     * <p><br>
     * This builder provides a fluent API for setting certain object properties and creating a new immutable
     * {@link SourceTypeDTO} instance based on these properties. New builders may be initialized with some existing DTO
     ...
     */
    public static class Builder extends SourceTypeDTOBuilder {}
}
