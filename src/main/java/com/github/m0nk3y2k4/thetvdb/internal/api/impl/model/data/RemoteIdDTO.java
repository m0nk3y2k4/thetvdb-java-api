...
public abstract class RemoteIdDTO implements RemoteId {
     ...
     * RemoteIdDTO} instance based on these properties. New builders may be initialized with some existing DTO instance,
