...
/**
 * DTO implementation of the {@link UserInfo} interface
 * <p><br>
...
@JsonDeserialize(builder = UserInfoDTO.Builder.class)
public abstract class UserInfoDTO implements UserInfo {

    /**
     * Builder used to create a new immutable {@link UserInfoDTO} implementation
     * <p><br>
     * This builder provides a fluent API for setting certain object properties and creating a new immutable
     * {@link UserInfoDTO} instance based on these properties. New builders may be initialized with some existing DTO
     ...
     */
    public static class Builder extends UserInfoDTOBuilder {}
}
