...
@JsonDeserialize(builder = TranslationsDTO.Builder.class)
public abstract class TranslationsDTO implements Translations {
     ...
     */
    public static class Builder extends TranslationsDTOBuilder {}
}
