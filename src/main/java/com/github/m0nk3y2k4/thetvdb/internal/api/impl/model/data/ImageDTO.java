...
public abstract class ImageDTO implements Image {
    ...
    public Double getRatingAverage() {
        return Optional.ofNullable(getRatingsInfo()).map(ri -> ri.get("average")).map(Integer.class::cast)
    ...
    /**
     * Wraps the content of the Images' nested <em>{@code ratingsInfo}</em> JSON node in order to flatten the hierarchy
     * of this DTO.
     *
     ...
     * ImageDTO} instance based on these properties. New builders may be initialized with some existing DTO instance,
