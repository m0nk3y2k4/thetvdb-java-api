...
/**
 * DTO implementation of the {@link TagOption} interface
 * <p><br>
...
@JsonDeserialize(builder = TagOptionDTO.Builder.class)
public abstract class TagOptionDTO implements TagOption {

    /**
     * Builder used to create a new immutable {@link TagOptionDTO} implementation
     * <p><br>
     * This builder provides a fluent API for setting certain object properties and creating a new immutable
     * {@link TagOptionDTO} instance based on these properties. New builders may be initialized with some existing DTO
     ...
     */
    public static class Builder extends TagOptionDTOBuilder {}
}
