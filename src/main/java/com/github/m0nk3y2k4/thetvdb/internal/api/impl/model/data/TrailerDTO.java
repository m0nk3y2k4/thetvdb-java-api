...
public abstract class TrailerDTO implements Trailer {
     ...
     * TrailerDTO} instance based on these properties. New builders may be initialized with some existing DTO instance,
