...
/**
 * DTO implementation of the {@link Studio} interface
 * <p><br>
...
@JsonDeserialize(builder = StudioDTO.Builder.class)
public abstract class StudioDTO implements Studio {

    /**
     * Builder used to create a new immutable {@link StudioDTO} implementation
     * <p><br>
     * This builder provides a fluent API for setting certain object properties and creating a new immutable {@link
     * StudioDTO} instance based on these properties. New builders may be initialized with some existing DTO instance,
     ...
     */
    public static class Builder extends StudioDTOBuilder {}
}
