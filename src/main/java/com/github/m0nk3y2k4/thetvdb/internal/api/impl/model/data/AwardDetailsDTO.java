...
/**
 * DTO implementation of the {@link AwardDetails} interface
 * <p><br>
 ...
 * {@link AwardDetailsDTO.Builder}.
 */
@Immutable
@APIDataModel
@WithHiddenImplementation
@JsonDeserialize(builder = AwardDetailsDTO.Builder.class)
public abstract class AwardDetailsDTO implements AwardDetails {

    /**
     * Builder used to create a new immutable {@link AwardDetailsDTO} implementation
     * <p><br>
     * This builder provides a fluent API for setting certain object properties and creating a new immutable
     * {@link AwardDetailsDTO} instance based on these properties. New builders may be initialized with some existing
     ...
     */
    public static class Builder extends AwardDetailsDTOBuilder {}
}
