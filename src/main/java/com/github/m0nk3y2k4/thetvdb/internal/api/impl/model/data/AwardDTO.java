...
/**
 * DTO implementation of the {@link Award} interface
 * <p><br>
...
@JsonDeserialize(builder = AwardDTO.Builder.class)
public abstract class AwardDTO implements Award {

    /**
     * Builder used to create a new immutable {@link AwardDTO} implementation
     * <p><br>
     * This builder provides a fluent API for setting certain object properties and creating a new immutable {@link
     * AwardDTO} instance based on these properties. New builders may be initialized with some existing DTO instance,
     ...
     */
    public static class Builder extends AwardDTOBuilder {}
}
