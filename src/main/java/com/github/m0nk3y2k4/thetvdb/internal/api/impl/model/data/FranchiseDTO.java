...
/**
 * DTO implementation of the {@link Franchise} interface
 * <p><br>
...
@JsonDeserialize(builder = FranchiseDTO.Builder.class)
public abstract class FranchiseDTO implements Franchise {

    /**
     * Builder used to create a new immutable {@link FranchiseDTO} implementation
     * <p><br>
     * This builder provides a fluent API for setting certain object properties and creating a new immutable {@link
     * FranchiseDTO} instance based on these properties. New builders may be initialized with some existing DTO
     ...
     */
    public static class Builder extends FranchiseDTOBuilder {}
}
