...
/**
 * DTO implementation of the {@link EntityUpdate} interface
 * <p><br>
...
@JsonDeserialize(builder = EntityUpdateDTO.Builder.class)
public abstract class EntityUpdateDTO implements EntityUpdate {

    /**
     * Builder used to create a new immutable {@link EntityUpdateDTO} implementation
     * <p><br>
     * This builder provides a fluent API for setting certain object properties and creating a new immutable
     * {@link EntityUpdateDTO} instance based on these properties. New builders may be initialized with some existing
     ...
     */
    public static class Builder extends EntityUpdateDTOBuilder {}
}
