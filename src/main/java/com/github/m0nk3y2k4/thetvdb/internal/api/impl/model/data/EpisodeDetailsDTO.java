...
/**
 * DTO implementation of the {@link EpisodeDetails} interface
 * <p><br>
...
@JsonDeserialize(builder = EpisodeDetailsDTO.Builder.class)
public abstract class EpisodeDetailsDTO implements EpisodeDetails {

    /**
     * Builder used to create a new immutable {@link EpisodeDetailsDTO} implementation
     * <p><br>
     * This builder provides a fluent API for setting certain object properties and creating a new immutable
     * {@link EpisodeDetailsDTO} instance based on these properties. New builders may be initialized with some existing
     ...
     */
    public static class Builder extends EpisodeDetailsDTOBuilder {}
}
