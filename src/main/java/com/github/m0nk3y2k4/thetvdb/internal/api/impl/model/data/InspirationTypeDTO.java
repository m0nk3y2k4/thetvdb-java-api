...
/**
 * DTO implementation of the {@link InspirationType} interface
 * <p><br>
...
@JsonDeserialize(builder = InspirationTypeDTO.Builder.class)
public abstract class InspirationTypeDTO implements InspirationType {
    ...
    /**
     * Builder used to create a new immutable {@link InspirationTypeDTO} implementation
     * <p><br>
     * This builder provides a fluent API for setting certain object properties and creating a new immutable
     * {@link InspirationTypeDTO} instance based on these properties. New builders may be initialized with some existing
     ...
     */
    public static class Builder extends InspirationTypeDTOBuilder {}
}
