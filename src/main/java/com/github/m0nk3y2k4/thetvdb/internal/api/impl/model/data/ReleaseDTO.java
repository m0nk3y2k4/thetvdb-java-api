...
/**
 * DTO implementation of the {@link Release} interface
 * <p><br>
...
@JsonDeserialize(builder = ReleaseDTO.Builder.class)
public abstract class ReleaseDTO implements Release {

    /**
     * Builder used to create a new immutable {@link ReleaseDTO} implementation
     * <p><br>
     * This builder provides a fluent API for setting certain object properties and creating a new immutable {@link
     * ReleaseDTO} instance based on these properties. New builders may be initialized with some existing DTO instance,
     ...
     */
    public static class Builder extends ReleaseDTOBuilder {}
}
