...
/**
 * DTO implementation of the {@link AwardNominee} interface
 * <p><br>
...
@JsonDeserialize(builder = AwardNomineeDTO.Builder.class)
public abstract class AwardNomineeDTO implements AwardNominee {

    /**
     * Builder used to create a new immutable {@link AwardNomineeDTO} implementation
     * <p><br>
     * This builder provides a fluent API for setting certain object properties and creating a new immutable
     * {@link AwardNomineeDTO} instance based on these properties. New builders may be initialized with some existing
     ...
     */
    public static class Builder extends AwardNomineeDTOBuilder {}
}
