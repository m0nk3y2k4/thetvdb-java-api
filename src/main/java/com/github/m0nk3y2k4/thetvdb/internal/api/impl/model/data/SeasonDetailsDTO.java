...
/**
 * DTO implementation of the {@link SeasonDetails} interface
 * <p><br>
...
@JsonDeserialize(builder = SeasonDetailsDTO.Builder.class)
public abstract class SeasonDetailsDTO implements SeasonDetails {

    /**
     * Builder used to create a new immutable {@link SeasonDetailsDTO} implementation
     * <p><br>
     * This builder provides a fluent API for setting certain object properties and creating a new immutable
     * {@link SeasonDetailsDTO} instance based on these properties. New builders may be initialized with some existing
     ...
     */
    public static class Builder extends SeasonDetailsDTOBuilder {}
}
