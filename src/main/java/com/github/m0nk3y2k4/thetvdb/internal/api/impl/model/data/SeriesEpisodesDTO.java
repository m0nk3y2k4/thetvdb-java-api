...
/**
 * DTO implementation of the {@link SeriesEpisodes} interface
 * <p><br>
...
@JsonDeserialize(builder = SeriesEpisodesDTO.Builder.class)
public abstract class SeriesEpisodesDTO implements SeriesEpisodes {

    /**
     * Builder used to create a new immutable {@link SeriesEpisodesDTO} implementation
     * <p><br>
     * This builder provides a fluent API for setting certain object properties and creating a new immutable
     * {@link SeriesEpisodesDTO} instance based on these properties. New builders may be initialized with some existing
     ...
     */
    public static class Builder extends SeriesEpisodesDTOBuilder {}
}
