...
/**
 * DTO implementation of the {@link Entity} interface
 * <p><br>
...
@JsonDeserialize(builder = EntityDTO.Builder.class)
public abstract class EntityDTO implements Entity {

    /**
     * Builder used to create a new immutable {@link EntityDTO} implementation
     * <p><br>
     * This builder provides a fluent API for setting certain object properties and creating a new immutable {@link
     * EntityDTO} instance based on these properties. New builders may be initialized with some existing DTO instance,
     ...
     */
    public static class Builder extends EntityDTOBuilder {}
}
