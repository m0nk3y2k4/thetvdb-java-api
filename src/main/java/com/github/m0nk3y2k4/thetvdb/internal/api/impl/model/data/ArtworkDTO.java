...
public abstract class ArtworkDTO implements Artwork {
     ...
     * ArtworkDTO} instance based on these properties. New builders may be initialized with some existing DTO instance,
