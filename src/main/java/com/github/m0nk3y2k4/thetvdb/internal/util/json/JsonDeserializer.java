...
public final class JsonDeserializer {
    ...
    /**
     * Maps the actual parameters returned by the various routes responsible for providing a list of available query parameters to be used
     * for certain queryable requests.
     * <p><br>
     * Note: Some routes will return the query parameters directly within the <em>{@code data}</em> node whereas for other routes the parameters
     * may be located in a nested <em>{@code params}</em> sub-node. If such a nested node is present, the parameters will be parsed from this node.
     * Otherwise the parameters will be parsed from the <em>{@code data}</em> node.
     *
     * @param json The full JSON as returned by the remote service, containing a list of query parameters in either the <em>{@code data}</em> node
     *             or a nested <em>{@code params}</em> sub-node
     *
     * @return Extended API response containing a list of query parameters parsed from the given JSON. The returned object typically doesn't contain
     *         any additional error and paging information as such data is usually not available for remote routes used in conjunction with this method.
     *
     ...
     *
     * @return Extended API response containing a list of favorites parsed from the given JSON as well as optional, additional error information. The
     *         returned object typically doesn't contain any additional paging information as such data is usually not available for remote routes
     ...
     *
     * @param json The full JSON as returned by the remote service, containing a list of matching search results within the <em>{@code data}</em> node
     *
     * @return Extended API response containing a list of search results parsed from the given JSON. The returned object typically doesn't contain
     ...
     *
     * @param json The full JSON as returned by the remote service, containing the matching series information within the <em>{@code data}</em> node
     *
     * @return Extended API response containing the series data parsed from the given JSON as well as optional, additional error information. The
     *         returned object typically doesn't contain any additional paging information as such data is usually not available for remote routes
     *         used in conjunction with this method.
     *
     * @throws APIException If an IO error occurred during the deserialization of the given JSON object
     ...
     *
     * @param json The full JSON as returned by the remote service, containing the episode information within the <em>{@code data}</em> node
     *
     * @return Extended API response containing the episode data parsed from the given JSON as well as optional, additional error information. The
     *         returned object typically doesn't contain any additional paging information as such data is usually not available for remote routes
     *         used in conjunction with this method.
     *
     * @throws APIException If an IO error occurred during the deserialization of the given JSON object
     ...
     * <p><br>
     * The remote API will only return 100 matching records at most. Additional records may be fetched by using the paging information
     * which may be accessed via the returned API response object (see {@link APIResponse#getLinks()}).
     *
     * @param json The full JSON as returned by the remote service, containing a list of episode information within the <em>{@code data}</em> node
     *
     * @return Extended API response containing a list of episodes parsed from the given JSON as well as optional, additional error and paging information.
     *
     * @throws APIException If an IO error occurred during the deserialization of the given JSON object
     */
     ...
     *
     * @param json The full JSON as returned by the remote service, containing a list of available languages within the <em>{@code data}</em> node
     *
     * @return Extended API response containing a list of available languages parsed from the given JSON. The returned object typically doesn't contain
     *         any additional error or paging information as such data is usually not available for remote routes used in conjunction with this method.
     *
     * @throws APIException If an IO error occurred during the deserialization of the given JSON object
     */
     ...
     *
     * @param json The full JSON as returned by the remote service, containing the language information within the <em>{@code data}</em> node
     *
     * @return Extended API response containing the language data parsed from the given JSON. The returned object typically doesn't contain
     *         any additional error or paging information as such data is usually not available for remote routes used in conjunction with this method.
     *
     * @throws APIException If an IO error occurred during the deserialization of the given JSON object
     */
     ...
     *
     * @param json The full JSON as returned by the remote service, containing a list of actor information within the <em>{@code data}</em> node
     *
     * @return Extended API response containing a list of actors parsed from the given JSON as well as optional, additional error information. The
     *         returned object typically doesn't contain any additional paging information as such data is usually not available for remote routes
     *         used in conjunction with this method.
     *
     * @throws APIException If an IO error occurred during the deserialization of the given JSON object
     ...
     *
     * @param json The full JSON as returned by the remote service, containing the series episode summary information within the <em>{@code data}</em> node
     *
     * @return Extended API response containing the episode summary data parsed from the given JSON. The returned object typically doesn't contain
     *         any additional error or paging information as such data is usually not available for remote routes used in conjunction with this method.
     *
     * @throws APIException If an IO error occurred during the deserialization of the given JSON object
     */
     ...
     *
     * @param json The full JSON as returned by the remote service, containing a list of image query parameters within the <em>{@code data}</em> node
     *
     * @return Extended API response containing a list of image query parameters parsed from the given JSON. The returned object typically doesn't contain
     *         any additional error or paging information as such data is usually not available for remote routes used in conjunction with this method.
     *
     * @throws APIException If an IO error occurred during the deserialization of the given JSON object
     */
     ...
     *
     * @param json The full JSON as returned by the remote service, containing the series images information within the <em>{@code data}</em> node
     *
     * @return Extended API response containing the series images data parsed from the given JSON. The returned object typically doesn't contain
     *         any additional error or paging information as such data is usually not available for remote routes used in conjunction with this method.
     *
     * @throws APIException If an IO error occurred during the deserialization of the given JSON object
     */
     ...
     *
     * @param json The full JSON as returned by the remote service, containing a list of image information within the <em>{@code data}</em> node
     *
     * @return Extended API response containing a list of images parsed from the given JSON as well as optional, additional error information. The
     *         returned object typically doesn't contain any additional paging information as such data is usually not available for remote routes
     *         used in conjunction with this method.
     *
     * @throws APIException If an IO error occurred during the deserialization of the given JSON object
     ...
     * <p><br>
     * The JSON data will be parsed into a map which keys represent the ID of the updated series while their the corresponding values represent the
     * actual date/time of the last update as epoch time.
     *
     * @param json The full JSON as returned by the remote service, containing key/value pairs of recently updated series within the <em>{@code data}</em> node
     *
     * @return Extended API response containing a map of last updated series parsed from the given JSON as well as optional, additional error information.
     *         The returned object typically doesn't contain any additional paging information as such data is usually not available for remote routes
     *         used in conjunction with this method.
     *
     * @throws APIException If an IO error occurred during the deserialization of the given JSON object
     */
     ...
     *
     * @param json The full JSON as returned by the remote service, containing a list of rating information within the <em>{@code data}</em> node
     *
     * @return Extended API response containing a list of ratings parsed from the given JSON as well as optional, additional paging information.
     *         The returned object typically doesn't contain any additional error information as such data is usually not available for remote routes
     *         used in conjunction with this method.
     *
     * @throws APIException If an IO error occurred during the deserialization of the given JSON object
     */
     ...
     *
     * @param json The full JSON as returned by the remote service, containing the user information within the <em>{@code data}</em> node
     *
     * @return Extended API response containing the user data parsed from the given JSON. The returned object typically doesn't contain
     *         any additional error or paging information as such data is usually not available for remote routes used in conjunction with this method.
     *
     * @throws APIException If an IO error occurred during the deserialization of the given JSON object
     */
     ...
     *
     * @return New throwable mapping function based on the given type reference. This function may throw exceptions of the type {@link IOException} when
     *         invoking it's <i>apply</i> method.
     */
    ...
    /**
     * Creates a new JSON object mapper module which uses the given type reference to perform a functional deserialization
     * of the JSON's <em>{@code data}</em> node when parsing a parameterized API response.
     *
    ...
    /**
     * Creates a new JSON object mapper module which uses the given supplier to perform a functional deserialization
     * of the JSON's <em>{@code data}</em> node when parsing a parameterized API response. As it is not possible to access
     * the actual JSON data from within the supplier, modules created by this method may primarily be used to specify some
     * default object mapping (without parsing the actual JSON).
     *
     * @param supplier Supplier returning some default value without actually parsing the JSON <em>{@code data}</em> node
     * @param <T> The type of object that the <em>{@code data}</em> node should be mapped to
     *
     * @return Simple JSON object mapper module containing a single functional deserializer
     */
    ...
    /**
     * Creates a new JSON object mapper module which uses the given function to perform a functional deserialization
     * of the JSON's <em>{@code data}</em> node when parsing a parameterized API response. The given function will receive
     ...
     * default value while completely ignoring the JSON's content.
     *
     * @see #createFunctionalModule(ThrowableFunctionalInterfaces.Function) createFunctionalModule(throwableFunction)
     *
     * @param dataFunction The function to be used to parse the JSON's <em>{@code data}</em> node. The object returned by this
     *                     function will be considered to be the valid outcome of parsing this node.
     * @param <T> The type of object that the <em>{@code data}</em> node should be mapped to
     *
     * @return Simple JSON object mapper module containing a single functional deserializer
     */
    ...
    /**
     * Deserializes the given JSON based on the given type reference to a new object of type <b>T</b>. A new functional module which
     * is based on the given type reference will be used in order to map the JSON's top-level <em>{@code data}</em> node.
     *
    ...
    /**
     * Deserializes the given JSON based on the given type reference to a new object of type <b>T</b>. The given mapping module
     * will be registered prior to the actual parsing in order to extend the mapper with additional functionality required
...
/**
 * Specific JSON deserializer for parsing an API response providing some extended JSON <em>{@code data}</em> node processing capabilities.
 * <p><br>
