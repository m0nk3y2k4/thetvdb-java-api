...
/**
 * DTO implementation of the {@link SeriesDetails} interface
 * <p><br>
...
@JsonDeserialize(builder = SeriesDetailsDTO.Builder.class)
public abstract class SeriesDetailsDTO implements SeriesDetails {

    /**
     * Builder used to create a new immutable {@link SeriesDetailsDTO} implementation
     * <p><br>
     * This builder provides a fluent API for setting certain object properties and creating a new immutable
     * {@link SeriesDetailsDTO} instance based on these properties. New builders may be initialized with some existing
     ...
     */
    public static class Builder extends SeriesDetailsDTOBuilder {}
}
